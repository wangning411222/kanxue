<template>
	<view id="fl_signin">
		...
		<view class="footer">
			<view class="tip">
				<text class="text-red">●</text> 未签
				<text class="text-blue margin-left-sm">●</text> 已签
				
				<text style="float: right;">小提示：点击日期即可进行签到{{repair?"或补签":""}}</text>
			</view>
...
<script>
	export default {
		...
		created() {
			this.ready();
			this.signin_fun(this.days[this.day_index]);
		},
